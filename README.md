...
### Comments
* Leveraged provided starter template
* Break points added at widths of 980px, 768px and 640px
* CSS animations added in infinite alternation at 980px breakpoint for background image
